...
module theplate()
{
 translate([0,0,0]) cube([80,40,5]);
 translate([20,40,0]) cube([40,40,5]);       
...
difference(){
 ...
 translate([20+10,30+40,-3]) m5_bolt(30);
 translate([20+30,10+40,-3]) m5_bolt(30);
 translate([20+10,10+40,-3]) m5_bolt(30);
 translate([20+30,30+40,-3]) m5_bolt(30);     
